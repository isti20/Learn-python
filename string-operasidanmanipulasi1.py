...
print("index ke-(-1) : " + nama_lengkap[-1]) # indexing dari dibelakang (dimulai dari -1)
print("index ke-(-5,-2) : " + nama_lengkap[-5:-1]) # indexing dari dibelakang ke-5 dan ke-1
print("index ke-[6,8] : " + nama_lengkap[6:8]) # dimulai dari index 6 sampai sebelum 8
print("index ke-[0,5] : " + nama_lengkap[:5]) # dimulai dari index 0 sampai sebelum 5
print("index ke-[2,terakhir] : " + nama_lengkap[2:]) # dimulai dari index 2 sampai terakhir
...
txt = "Halo, otong dan dudung."
x = txt.find("otong")
y = txt.index("otong")
print("Kata otong dimulai dari index ke-:", x)
print("Kata otong dimulai dari index ke-:", y)